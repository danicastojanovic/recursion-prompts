...
var reverseArr = function(array) {
  ...
  result = result.concat(array.slice(array.length-1), reverseArr(array.slice(0, array.length-1)));
  return result;
};
...
var buildList = function(value, length) {
  ...
  result = result.concat([value], buildList(value, length-1));
  return result;
};
...
var capitalizeFirst = function(array) {
  ...
  if (array.length === 0) {
    ...
    var result = [];
    return result = result.concat([array[0][0].toUpperCase()+ array[0
    ].slice(1)], capitalizeFirst(array.slice(1)));
  }
};
